...
It is used to identify MySQL instance that is exposed metrics, and then we can use it to do label grouping in the future. See [Example sidecar container](./deployment.yaml#L87) if you're deploying it as sidecar container.
